...
export const PUBLIC_ENVIRONMENT = {
  ...
  COINGECKO_KEY: process.env.COINGECKO_KEY as string,
  COINGECKO_PLAN: process.env.COINGECKO_PLAN as string,
};
...
export const FAIRYRING_ENV = {
  ...
  coinGeckoKey: PUBLIC_ENVIRONMENT.COINGECKO_KEY,
  coinGeckoPlan: PUBLIC_ENVIRONMENT.COINGECKO_PLAN,
};
